...
(let ((pkgs-to-install
       '(dash s projectile use-package diminish bind-key company company-anaconda
         ...
         fill-column-indicator company-tabnine helm-make prettier-js indent-guide origami)))
...
(global-set-key (kbd "C-c 1") 'hydra-origami/body) ;; so we allway ssee the menu
