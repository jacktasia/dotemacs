...
(let ((pkgs-to-install
       '(dash s projectile use-package diminish bind-key company company-anaconda
         ...
         fill-column-indicator company-tabnine helm-make prettier-js indent-guide)))
