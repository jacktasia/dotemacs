...
(let ((pkgs-to-install
       '(dash s projectile use-package diminish bind-key company company-anaconda
         ...
         git-link smartparens move-text add-node-modules-path visible-mark cider terraform-mode)))
