...
(let ((pkgs-to-install
       '(dash s projectile use-package diminish bind-key company company-anaconda
         ...
         vagrant-tramp emamux gh-md google-translate ivy-rich dockerfile-mode golden-ratio blacken fill-column-indicator)))
